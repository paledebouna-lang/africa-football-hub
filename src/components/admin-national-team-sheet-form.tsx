...
/**
 * National-team counterpart of AdminTeamSheetForm — same shape, wired to
 * saveNationalTeamSheet and keyed by countryId instead of clubId.
 */
export function AdminNationalTeamSheetForm({
  action,
  matchId,
  countryId,
  rows,
  ...
  return (
    <form action={formAction} className="space-y-5">
      ...
      <p className="rounded-md bg-brand/5 p-3 text-xs text-muted">
        ...
        sélections, les statistiques et la valeur marchande des joueurs.
      </p>
      ...
      <div className="flex items-center gap-3">
        ...
        <Link
          href={`/admin/countries/${countryId}/matches`}
