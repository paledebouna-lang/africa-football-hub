...
/**
 * Home page hero. With an active YouTube video it plays muted and looped
 * behind the headline (privacy-friendly nocookie host); without one — or for
 * visitors who prefer reduced motion — it falls back to the plain blue panel.
 */
