...
export function playerFormLabels(t: Translator) {
  return {
    ...
    uploadChoose: t("upload.choose"),
    uploadWorking: t("upload.working"),
    uploadRemove: t("upload.remove"),
    uploadNone: t("upload.none"),
    uploadDone: t("upload.done"),
    uploadFailed: t("upload.failed"),
    uploadSignIn: t("upload.signInRequired"),
